...
> Generado: 2026-08-04 11:42 · commit: 035bf24
...
| `07_util.js` | Helpers compartidos. Sin estado propio; todo deriva del MAESTRO | 23 |
| `08_webapp.js` | Web App interna (acceso "solo yo", ejecutar como yo) | 65 |
| `09_selftest.js` | Verificación end-to-end (handoff: "ejecutar, no asumir") | 45 |
...
**07_util.js:** getMaestro ahoraISO hoyISO mesISO aFechaISO fechaHoraCorta_ ensureSheet aplicarFormatoTexto leerTabla appendFila sanitizarCelda conLock abrirCliente _trashArchivo_ getConfig configPrefijo_ setConfig nextId protegerSheet _sinTildes_ _fmtMiles_ _valorPalabras_ normalizarCifrasTexto_ 
