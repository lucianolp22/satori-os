...
- **AREL — pendiente de Luciano:** `clasp push -f` + abrir la Web App (desktop **y** móvil) y verificar (el iframe cross-origin no es auto-verificable por Chrome).
